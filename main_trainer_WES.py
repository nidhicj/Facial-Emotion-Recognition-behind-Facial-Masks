...
def main():
    ...
    prec1 = test(test_loader, basemodel, criterion, optimizer1,  epoch, args.num_classes,args.epochs )
    print("Epoch: {}  Train Acc:{} Test Acc: {}".format(epoch,model, prec1))
    ...
    ax1.set_title('Train, Valid and Test Losses')
    os.chdir(args.main_folder)
    f1.savefig(args.title+'Losses')
    ...
    os.chdir(args.main_folder)
    f2.savefig(args.title+'Accuracy')
